...
CHANNELS = [
    {"api_id": 1, "name": "RCTI (R+)", "logo": "https://www.visionplus.id/images/repository/580/580-LOGO-m.png"},
    {"api_id": 2, "name": "MNCTV (R+)", "logo": "https://www.visionplus.id/images/repository/581/581-LOGO-m.png"},
    {"api_id": 3, "name": "GTV (R+)", "logo": "https://www.visionplus.id/images/repository/582/582-LOGO-m.png"},
    {"api_id": 4, "name": "iNews (R+)", "logo": "https://www.visionplus.id/images/repository/583/583-LOGO-m.png"}
]
...
def generate_m3u_content(channels_data):
    ...
    for ch in channels_data:
        lines.append(f'#EXTINF:-1 tvg-id="{ch["name"]}" group-title="INDONESIA" tvg-logo="{ch["logo"]}",{ch["name"]}')
